    ...
    $id_tamu = $_GET["id"];
    $query_daftartamu = "SELECT * FROM daftartamu WHERE id = $id_tamu";
                                    ...
                                    <form action="" method="post">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="kode_tamu" name="kode_tamu" value="<?= $row_daftartamu["kode_tamu"]; ?>" placeholder="Masukkan Nama tamu" readonly>
                                                ...
                                                <input type="hidden" class="form-control" id="edited" name="edited" value="1" readonly>
    ...
    if (isset($_POST["submit"])) {
        ...
        if ($edit) {
            ...
            echo '<script>
        Swal.fire({
            title: "Apakah yakin Menerima Data ini?",
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    title: "TERIMA!",
                    text: "Data ini berhasil di terima",
                    icon: "success"
                }).then(() => {
            ...
            echo "<script type='text/javascript'>
                ...
                document.location.href = 'daftartamu-edit.php?id=$id_tamu';
            </script>";
        }
    }
    ?>