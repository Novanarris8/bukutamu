...
if (isset($_POST["submit"])) {
    ...
    if ($edit) {
        ...
        echo "<script type='text/javascript'> 
            ...
            document.location.href = 'pemohon-edit.php?id_pemohon=$id_pemohon'; 
            </script>";
    }
}
?>
                                ...
                                <form action="" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label for="surat_pemohon">Surat Pemohon : </label><br>
                                                <a href="../assets/files/<?php echo $row_pemohon["surat_pemohon"]; ?>" target="_blank"><i class="fa fa-file-pdf-o"> </i> <?php echo $row_pemohon["surat_pemohon"]; ?></a>
                                            </div>
                                            <div class="card-footer">
                                                <button type="submit" name="submit" class="btn btn-primary mr-1">Verifikasi</button>
                                                <a href="pemohon-ditolak.php?id_pemohon=<?php echo $row_pemohon["id_pemohon"]; ?>" class="btn btn-danger">Tolak</a>
                                            </div>
                                        </div>
                                </form>
                            </div>
