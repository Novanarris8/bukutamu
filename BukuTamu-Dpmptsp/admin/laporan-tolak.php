...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($tanggal_menunggu_dari) && !empty($tanggal_menunggu_sampai)) {
        $queryMemanggil = "SELECT * FROM tbl_pemohon 
                                                    ...
                                                    WHERE tbl_pemohon.status_pemohon='Tolak'";
...
<body class="hold-transition sidebar-mini">
                    ...
                    <form method="post" action="">
                        <div class="form-group">
                            ...
                            <div class="btn-group">
                                ...
                                <a href="laporan-tolak.php" class="btn btn-secondary mr-2" style="text-decoration: none;"><i class="fas fa-undo"></i> Reset</a>
    ...
    AND tbl_pemohon.status_pemohon = 'Tolak'
                            ...
                            while ($row_menunggu = mysqli_fetch_assoc($result_menunggu)) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $row_menunggu['alasan']; ?> </td>
                                </tr>
    ...
    <script>
        function printmenunggu() {
            ...
            var url = 'cetak-tolak.php?print=true';
