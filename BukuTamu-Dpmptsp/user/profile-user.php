                                    ...
                                    <div class="card-body px-5 pb-5">
                                        ...
                                        <form class="row g-3" method="POST" target="" enctype="multipart/form-data">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <input type="text" class="form-control text-center" name="nama_user" id="nama_user" value="<?= $row_user["nama_user"] ?>" readonly>
                                            </div>
                                            <div class="col-4">
                                                <label for="username" class="form-label">Username :</label>
                                                <input type="text" class="form-control text-center" name="username" id="username" value="<?= $row_user["username"] ?>" readonly>
                                            </div>
                                            <div class="col-4">
                                            ...
                                            <!-- <div class="col-4">
                                                ...
                                                <input type="number" class="form-control" name="nip" id="nip" value="<?= $row_user["nip"] ?>" readonly>
                                            </div> -->
                                            <div class="col-4">
                                                <label for="email" class="form-label">Email :</label>
                                                <input type="email" class="form-control" name="email" id="email" value="<?= $row_user["email"] ?>" readonly>
                                            </div>
                                            <!-- <div class="col-4"></div> -->
                                            <div class="col-2">
                                            ...
                                            <!-- <div class="col-4">
                                                ...
                                                <input type="text" class="form-control" name="kode_user" id="kode_user" value="<?= $row_user["kode_user"] ?>" readonly>
                                            </div> -->
                                            <div class="col-2">
                                            ...
                                            <div class="col-8">
                                                ...
                                                <input type="text" class="form-control" name="alamat" id="alamat" value="<?= $row_user["alamat"] ?>" readonly>
                                            </div>
                                            <div class="col-12 mt-3">
                                                <a href="profile-edit.php?id=<?= $row_user["id"] ?>&id_user=<?= $row_user["id_user"] ?>" class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i>Edit Profile</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
