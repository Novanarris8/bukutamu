                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="daftartamu-verifikasi.php?id=<?php echo $row["id"]; ?>" class="btn btn-success btn-xs mr-1"><i class="fa fa-edit">Konfirmasi</i></a>
                                            <!-- <a href="daftartamu-verifikasi.php?id=" class="btn btn-success btn-xs mr-1"><i class="fa fa-edit">Tolak</i></a> -->
                                            <a href="daftartamu-hapus.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger btn-xs text-light" onClick="return confirm('Anda yakin ingin hapus data ini?')"><i class="fa fa-trash"></i>Hapus</a>
                                        </td>
                                    </tr>
                                <?php $no++;
                                } ?>
