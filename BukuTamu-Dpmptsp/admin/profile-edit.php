...
if (isset($_POST["submit"])) {
    ...
    if ($edit && $edit2) {
        echo "<script>
            ...
            document.location.href = 'profile-user.php?id=$id&id_admin=$id_admin';
        </script>";
    } else {
        echo "<script>
                                    ...
                                    <div class="card-body px-5 pb-5">
                                        ...
                                        <form class="row g-3" method="POST" target="" enctype="multipart/form-data">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <input type="text" class="form-control text-center" name="nama_admin" id="nama_admin" value="<?= $row_admin["nama_admin"] ?>">
                                            </div>
                                            <div class="col-4">
                                                <label for="username" class="form-label">Username :</label>
                                                <input type="text" class="form-control text-center" name="username" id="username" value="<?= $row_admin["username"] ?>">
                                            </div>
                                            <div class="col-2"></div>
                                            <div class="col-2"></div>
                                            <div class="col-4">
                                                <label for="nip" class="form-label">Nomor Induk Pegawai :</label>
                                                <input type="number" class="form-control" name="nip" id="nip" value="<?= $row_admin["nip"] ?>">
                                            </div>
                                            <div class="col-4">
                                                <label for="email" class="form-label">Email :</label>
                                                <input type="email" class="form-control" name="email" id="email" value="<?= $row_admin["email"] ?>">
                                            </div>
                                            <div class="col-4"></div>
                                            <div class="col-2">
                                            ...
                                            <div class="col-2">
                                                ...
                                                <select class="form-select" name="jk" id="jk" value="<?= $row_pengguna["jk"] ?>">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <input type="text" class="form-control" name="no_telp" id="no_telp" value="<?= $row_admin["no_telp"] ?>">
                                            </div>
                                            <div class="col-4">
                                                <label for="kode_admin" class="form-label">Kode Admin :</label>
                                                <input type="text" class="form-control" name="kode_admin" id="kode_admin" value="<?= $row_admin["kode_admin"] ?>">
                                            </div>
                                            <div class="col-2"></div>
                                            <div class="col-2"></div>
                                            <div class="col-8">
                                                <label for="alamat" class="form-label">Alamat :</label>
                                                <input type="text" class="form-control" name="alamat" id="alamat" value="<?= $row_admin["alamat"] ?>">
                                            </div>
                                            <div class="col-2"></div>
                                            <div class="col-12">
