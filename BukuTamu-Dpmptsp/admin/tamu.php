...
$query = "SELECT * FROM tbl_pemohon A 
            ...
            LEFT JOIN tbl_user D ON A.kode_user = D.kode_user WHERE status_pemohon = '$diverif'";
...
<head>
    ...
    <title>Data Tamu | DPMPTSP KOTA BANJARMASIN</title>
