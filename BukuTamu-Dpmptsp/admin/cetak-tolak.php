...
<body onload="window.print();">
    <div class="container-fluid">
                    ...
                    <div class="col-sm-12">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                $tanggal_terima_dari = isset($_GET['tanggal_terima_dari']) ? $_GET['tanggal_terima_dari'] : '';
                                $tanggal_terima_sampai = isset($_GET['tanggal_terima_sampai']) ? $_GET['tanggal_terima_sampai'] : '';
        ...
        WHERE tbl_pemohon.status_pemohon = 'Tolak' ORDER BY tbl_pendaftaran.tanggal_daftar";
                                } else {
    ...
    AND tbl_pemohon.status_pemohon = 'Tolak'";
                                }
