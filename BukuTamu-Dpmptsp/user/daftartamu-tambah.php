...
if (isset($_POST['add'])) {
    ...
    //jalankan Query
    $query = "INSERT INTO daftartamu VALUES (NULL, '$nama_instansi', '$nama_tamu', '$jumlah', '$no_telepon', '$perihal_kunjungan', '$tanggal', '$jam','$surat_permohonan')";
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_instansi" name="nama_instansi" placeholder="Contoh: DPMPTSP Kabupaten Bekasi" required>
                                            <label for="nama_tamu">Nama Tamu :</label>
                                            <input type="text" class="form-control" id="nama_tamu" name="nama_tamu" placeholder="Contoh: Aulia Andini" required>
                                            <label for="jumlah">Jumlah :</label>
                                            <input type="text" class="form-control" id="jumlah" name="jumlah" placeholder="Contoh: 2" required>
                                            <label for="no_telepon">No Handphone :</label>
                                            <input type="text" class="form-control" id="no_telepon" name="no_telepon" placeholder="Contoh: 089611251123" required>
