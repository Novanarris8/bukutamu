...
$query = "SELECT * FROM tbl_pemohon A 
            ...
            LEFT JOIN tbl_user D ON A.kode_user = D.kode_user WHERE A.kode_user = '$kd_user'";
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            LEFT JOIN tbl_pendaftaran B ON A.id_daftar = B.id_daftar
                                            LEFT JOIN tbl_pegawai C ON B.id_pegawai = C.id_pegawai
                                            LEFT JOIN tbl_user D ON A.kode_user = D.kode_user WHERE A.kode_user = '$kd_user' AND status_pemohon = 'Menunggu'";
                                            $result = mysqli_query($conn, $query);
